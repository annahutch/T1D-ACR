...
args <- "4:171934268:A:G"

GWAS_data <- readRDS("../3-GWAS/Latest-residual-phenotype/output/combine-results/final-pooled-res.RDS")
...
system("plink --bfile LDdata/EUR_phase3.MAF_001.chr4 --extract 4:171934268:A:G_region.txt --r2 --ld-window-r2 0 --ld-window-kb 1000 --ld-window 9999 --out plink_output/4:171934268:A:G_ld")
