...
# imp 1
merged_fam$V6 <- phenotypes$averes.imp1[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 2
merged_fam$V6 <- phenotypes$averes.imp2[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 3
merged_fam$V6 <- phenotypes$averes.imp3[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 4
merged_fam$V6 <- phenotypes$averes.imp4[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 5
merged_fam$V6 <- phenotypes$averes.imp5[match(merged_fam$altID, phenotypes$StudyID)]
