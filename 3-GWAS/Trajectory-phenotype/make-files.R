...
# imp 1
merged_fam$V6 <- phenotypes.imp1$brms.Slope[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 2
merged_fam$V6 <- phenotypes.imp2$brms.Slope[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 3
merged_fam$V6 <- phenotypes.imp3$brms.Slope[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 4
merged_fam$V6 <- phenotypes.imp4$brms.Slope[match(merged_fam$altID, phenotypes$StudyID)]
...
# imp 5
merged_fam$V6 <- phenotypes.imp5$brms.Slope[match(merged_fam$altID, phenotypes$StudyID)]
